...
String _successHtml(String? appRedirectUrl) => '''<!DOCTYPE html>
<html class="mdl-js">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script type="text/javascript">
        function loadRedirectUrl() {
           window.location.href = ${jsonEncode(_isValidRedirectUrl(appRedirectUrl) ? appRedirectUrl : null)};
        }
        ${(_isValidRedirectUrl(appRedirectUrl)) ? 'window.onload = loadRedirectUrl;' : ''}
    </script>
</head>
<body>
<div>
